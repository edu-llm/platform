...
SCHEMA_MODELS: dict[str, type[BaseModel]] = {
    ...
    # decision: which tokenizers each published training image was seen to hold. Exported
    # because `tools/probe_image_tokenizers.py` writes entries a person then reviews, and a
    ...
    "image-tokenizers.schema.json": ImageTokenizerRecord,
