...
| measure | count |
| --- | --- |
| collected by pytest | 3814 |
| executed (excluding tests/test_phase0_proof.py, tests/test_phase1_proof.py, tests/test_phase2_proof.py, tests/test_phase3_proof.py, tests/test_phase5_proof.py) | 3635 |
| passed | 3634 |
| failed | 1 |
| errored | 0 |
| skipped | 0 |
