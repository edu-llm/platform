...
| measure | count |
| --- | --- |
| collected by pytest | 4500 |
| executed (excluding tests/test_phase0_proof.py, tests/test_phase1_proof.py, tests/test_phase2_proof.py, tests/test_phase3_proof.py, tests/test_phase5_proof.py) | 4307 |
| passed | 4305 |
| failed | 2 |
| errored | 0 |
| skipped | 0 |
