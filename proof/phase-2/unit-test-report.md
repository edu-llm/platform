...
| measure | count |
| --- | --- |
| collected by pytest | 3976 |
| executed (excluding tests/test_phase0_proof.py, tests/test_phase1_proof.py, tests/test_phase2_proof.py, tests/test_phase3_proof.py, tests/test_phase5_proof.py) | 3783 |
| passed | 3780 |
| failed | 3 |
| errored | 0 |
| skipped | 0 |
