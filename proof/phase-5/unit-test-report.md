...
| measure | count |
| --- | --- |
| collected by pytest | 4099 |
| executed (excluding tests/test_phase0_proof.py, tests/test_phase1_proof.py, tests/test_phase2_proof.py, tests/test_phase3_proof.py, tests/test_phase5_proof.py) | 3906 |
| passed | 3905 |
| failed | 1 |
| errored | 0 |
| skipped | 0 |
...
| tests/test_phase5_team_isolation.py | 13 | pass |
