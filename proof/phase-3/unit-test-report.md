...
| measure | count |
| --- | --- |
| collected by pytest | 3430 |
| executed (excluding tests/test_phase0_proof.py, tests/test_phase1_proof.py, tests/test_phase2_proof.py, tests/test_phase3_proof.py) | 3268 |
| passed | 3268 |
| failed | 0 |
| errored | 0 |
| skipped | 0 |
...
| tests/test_phase3_execution.py | 31 | pass |
