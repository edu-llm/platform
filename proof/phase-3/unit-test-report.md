...
| measure | count |
| --- | --- |
| collected by pytest | 3319 |
| executed (excluding tests/test_phase0_proof.py, tests/test_phase1_proof.py, tests/test_phase2_proof.py, tests/test_phase3_proof.py) | 3157 |
| passed | 3157 |
| failed | 0 |
| errored | 0 |
| skipped | 0 |
...
| tests/test_phase3_execution.py | 28 | pass |
