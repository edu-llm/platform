...
| measure | count |
| --- | --- |
| collected by pytest | 2023 |
| executed (excluding tests/test_phase0_proof.py, tests/test_phase1_proof.py) | 1953 |
| passed | 1953 |
| failed | 0 |
| errored | 0 |
| skipped | 0 |
...
| module | tests | result |
| --- | --- | --- |
| tests/test_capture_phase1_evidence_cli.py | 21 | pass |
