...
| measure | count |
| --- | --- |
| collected by pytest | 2705 |
| executed (excluding tests/test_phase0_proof.py, tests/test_phase1_proof.py) | 2620 |
| passed | 2620 |
| failed | 0 |
| errored | 0 |
| skipped | 0 |
...
| tests/test_phase1_deployer_role.py | 21 | pass |
