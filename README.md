...
**[Testing a module](guides/module-testing.md)** is the one to read when you have a change you want a result from this week. Which machine to pick for which size of job, what the waits actually are, which refusals you will meet and the one-line fix for each, and the three gaps worth knowing before you lose a day to one.
